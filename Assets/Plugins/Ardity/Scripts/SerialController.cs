...
public class SerialController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ReferenceEquals(message, SERIAL_DEVICE_CONNECTED))
            messageListener.SendMessage("OnConnectionEvent", true, SendMessageOptions.DontRequireReceiver);
        else if (ReferenceEquals(message, SERIAL_DEVICE_DISCONNECTED))
            messageListener.SendMessage("OnConnectionEvent", false, SendMessageOptions.DontRequireReceiver);
        else
            messageListener.SendMessage("OnMessageArrived", message, SendMessageOptions.DontRequireReceiver);
